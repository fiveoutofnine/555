    ...
    function render(uint256 _id) internal pure returns (string memory) {
        ...
        stylesBuffer.p(
            abi.encodePacked(
                ...
                "}.h{font-family:A}.i{font-family:B}.j{position:absolute;margin:auto 0;border-radius:100%;top:6px;width:12px;height:12px}</style>"
            )
        );
